...
package io.testrest.porterStemmer;
...
public class TestPorterStemmer {
    ...
    public void testStemFiles() throws IOException {
        BufferedReader inputReader = new BufferedReader(new FileReader("src/test/resources/stemming/input.txt"));
        BufferedReader expectedOutputReader = new BufferedReader(new FileReader("src/test/resources/stemming/output.txt"));
