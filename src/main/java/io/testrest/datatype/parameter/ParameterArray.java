...
public class ParameterArray extends StructuredParameterElement {
    ...
    public ParameterArray(ParameterElement parent, Parameter parameter, OperationNode operation, String name) {
...
//        other.elements.forEach(e -> elements.add(e.deepClone()));
    ...
    @Override
    public ParameterArray deepClone(OperationNode operation, ParameterElement parent) {
