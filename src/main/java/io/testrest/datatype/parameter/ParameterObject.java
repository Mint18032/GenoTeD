...
public class ParameterObject extends StructuredParameterElement {
    ...
    private static final Logger logger = Logger.getLogger(ParameterObject.class.getName());

    @SuppressWarnings("unchecked")
    public ParameterObject(ParameterElement parent, Parameter schema, OperationNode operation, String name)  {
    ...
    @Override
    public ParameterObject deepClone(OperationNode operation, ParameterElement parent) {
